...
<section class="relative flex flex-col md:flex-row items-center justify-between min-h-[80vh] overflow-hidden px-6 md:px-16 lg:px-24 bg-gradient-to-br from-purple-50 via-pink-50 to-red-50">
    
    <!-- Decorative Elements -->
    <div class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-purple-300/30 to-pink-300/30 rounded-full blur-3xl"></div>
    <div class="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-red-300/30 to-orange-300/30 rounded-full blur-3xl"></div>
    
    <!-- Text content -->
    <div class="relative z-10 max-w-3xl space-y-6 md:w-1/2 py-12">
        <div class="inline-block px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-semibold rounded-full shadow-lg">
            🎉 Welcome to GreatEvent
        </div>
        
        <h1 class="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 bg-clip-text text-transparent">
    ...
    <!-- Visual Element -->
    <div class="relative z-10 md:w-1/2 flex items-center justify-center py-12">
        <div class="relative w-full max-w-lg">
            <!-- Floating Cards Animation -->
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="absolute w-72 h-96 bg-gradient-to-br from-purple-400 to-pink-400 rounded-3xl shadow-2xl transform rotate-6 opacity-80"></div>
                <div class="absolute w-72 h-96 bg-gradient-to-br from-pink-400 to-red-400 rounded-3xl shadow-2xl transform -rotate-6 opacity-80"></div>
                <div class="relative w-80 h-[26rem] bg-white rounded-3xl shadow-2xl p-6 flex flex-col justify-between">
                    <div class="space-y-4">
...
<!-- Animated Ticker -->
<div class="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 text-white overflow-hidden whitespace-nowrap relative shadow-lg">
...
<section id="features" class="py-20 px-6 md:px-16 lg:px-24 bg-gradient-to-b from-white to-purple-50">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Feature 1 -->
            <div class="group p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-purple-100 hover:border-purple-300">
            ...
            <!-- Feature 2 -->
            <div class="group p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-pink-100 hover:border-pink-300">
                <div class="w-16 h-16 bg-gradient-to-br from-pink-500 to-red-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Feature 3 -->
            <div class="group p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-red-100 hover:border-red-300">
                <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-orange-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="py-20 px-6 md:px-16 lg:px-24 bg-white">
    <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between mb-12">
            <div>
                <h2 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
                    Upcoming Events
                </h2>
...
<!-- CTA Section -->
<section class="py-20 px-6 md:px-16 lg:px-24 bg-gradient-to-br from-purple-600 via-pink-600 to-red-600 text-white relative overflow-hidden">
