<x-layouts.app :title="__('Dashboard')">
    ...
    <section
        class="relative flex flex-col md:flex-row items-center justify-between h-[70vh] overflow-hidden px-10 text-white bg-gradient-to-r from-purple-300 via-purple-200 to-sky-200">
        ...
        <div class="relative z-10 max-w-3xl space-y-4 md:w-1/2">
            ...
            <p class="text-lg text-gray-100 leading-relaxed tracking-normal text-justify">
                Connect with people through shared experiences. Whether you’re looking for something fun to join or
                planning your own event,
                our community makes it simple to participate, create, and share the moment with others who share your
                passions.
            </p>
        ...
        <div class="relative z-10 mt-10 md:mt-0 md:w-1/2 flex justify-end">
            <img src="{{ asset('img/image1.jpg') }}" alt="Event illustration"
