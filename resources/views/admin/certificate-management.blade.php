<x-layouts.app.admin>
    <div class="max-w-7xl mx-auto px-6 py-6">
        ...
        <li class="flex items-center">
            ...
            <span class="text-gray-900 font-medium">Certificate Management</span>
        </li>
    </x-slot>
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Manage and download participant certificates for {{ $event->title }}
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="certificates_enabled" id="certificates_enabled"
                                    value="1" {{ $event->certificates_enabled ? 'checked' : '' }}
                                    class="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                            </div>
                            <div class="ml-3">
                                <label for="certificates_enabled" class="font-semibold text-gray-900">Enable
                                    Certificates</label>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="certificates_available_from"
                            ...
                            <p class="text-sm text-gray-500 mt-1">Leave blank to make certificates available immediately
                                when enabled</p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="certificate_message" rows="3"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                                placeholder="e.g., Congratulations on completing the event!">{{ $event->certificate_message }}</textarea>
                            <p class="text-sm text-gray-500 mt-1">This message will be shown to participants on the
                                certificate download page</p>
                        </div>
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Download certificates for all {{ $totalParticipants }}
                                participants</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">{{ $category['count'] }}
                                    participant{{ $category['count'] != 1 ? 's' : '' }} in this category</p>
                            </div>
                        </div>
            ...
            <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-700 mb-3">Share this link with participants so they can download
                            their certificates:</p>
                        <div class="flex items-center gap-2">
                            <input type="text" readonly
                                value="{{ route('participant.certificates', $event->id) }}" id="certificateLink"
