            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    <p class="text-sm text-gray-600">
                        Showing <span class="font-semibold text-gray-900">{{ $participantSummary->count() }}</span>
                        events
                    </p>
                </div>
            </div>
        @else
            ...
            <div class="p-16 text-center">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <p class="text-gray-500 mb-6">Get started by creating your first event to track participants and
                        engagement.</p>
                    <a href="{{ route('admin.create-event') }}"
