                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gradient-to-r from-slate-50 to-blue-50 border-b-2 border-blue-100">
                            <tr>
                                <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Member</th>
                                <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Role</th>
                                <th class="px-6 py-4 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Permissions</th>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        ...
                                        <p class="text-gray-400 text-sm mt-2">Add team members to help manage this event.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
