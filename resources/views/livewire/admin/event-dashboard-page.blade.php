                ...
                <tbody class="bg-white divide-y">
                    @forelse($latestParticipants as $p)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm font-medium text-gray-700">{{ $p->pivot->unique_id ?? '-' }}
                            </td>
                            <td class="px-4 py-3 text-xs">
                                @if ($p->pivot->status_bayaran === 'complete')
                                    <span
                                        class="px-2 py-1 text-green-700 bg-green-100 rounded-full font-semibold">Completed</span>
                                @else
                                    <span
                                        class="px-2 py-1 text-orange-700 bg-orange-100 rounded-full font-semibold">Pending</span>
                                @endif
                            </td>
                    ...
                    <div class="flex items-end justify-center gap-4">
                        ...
                        <div class="flex flex-col items-center flex-1 min-w-[30%]">
                            @if ($g2)
                                ...
                                <div
                                    class="w-full h-36 bg-gray-100 rounded-t-lg border-t border-x border-gray-300 p-2 text-center">
                        ...
                        <div class="flex flex-col items-center flex-1 min-w-[30%]">
                            @if ($g1)
                                ...
                                <div
                                    class="w-full h-48 bg-yellow-100 rounded-t-lg border-t border-x border-yellow-300 p-2 text-center">
                        ...
                        <div class="flex flex-col items-center flex-1 min-w-[30%]">
                            @if ($g3)
                                ...
                                <div
                                    class="w-full h-28 bg-orange-100 rounded-t-lg border-t border-x border-orange-300 p-2 text-center">
