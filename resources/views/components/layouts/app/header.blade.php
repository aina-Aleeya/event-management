...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <!-- Header Section -->
<header class="fixed top-0 left-0 z-50 w-full bg-purple-200/70 backdrop-blur-md border-b border-purple-300/50 shadow-md transition-all duration-300">
    <div class="flex w-full items-center justify-between px-6 py-2 text-gray-900">

        <!-- Left: Logo + System Name -->
        <div class="flex items-center">
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-2 hover:opacity-80 transition" wire:navigate>
                <x-app-logo class="size-8 text-purple-400" />
            </a>
        </div>

        <!-- Middle: Search Bar -->
        <div class="flex-none ml-1 relative w-full max-w-xs">
        ...
        <div class="flex items-center space-x-4">
            ...
            <button 
                class="px-3 py-1.5 rounded-lg hover:bg-blue-200 transition" 
        ...
        <div class="flex items-center space-x-4">
            ...
            @else
                <!-- Before Login -->
                <a href="{{ route('login') }}" class="text-sm font-medium text-black bg-purple-400 px-3 py-1.5 rounded-lg hover:bg-purple-500 transition">
                    Login
                </a>
                <a href="{{ route('register') }}" class="text-sm font-medium text-black bg-purple-400 px-3 py-1.5 rounded-lg hover:bg-purple-500 transition">
                    Register
                </a>
            @endauth
        </div>
